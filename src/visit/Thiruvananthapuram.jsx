import { ThiruWeb } from "../Components/Card"
import {  Link } from "react-router-dom"
import React from "react"

const Thiru1 = ({ name, specialty, rating, experience_notes, location, google_maps }) => {
    return (
        <>
...
const Thiruvananthapuram = () => {
    return (
        ...
        <>
            ...
            <h1 className='font-[Roboto] text-2xl mt-8 ml-10'>Thiruvananthapuram</h1>
            ...
            <div className='2xl-container mx-auto '>
                <div className='  w-[90%] mx-auto mt-8 justify-between items-center gap-8 grid md:grid-cols-2 lg:grid-cols-3'>
                    ...
                    {
                        ThiruWeb.map((items, index) => {
                            console.log(ThiruWeb)
                            return (
                                <Thiru1
                                    key={index}
                                    name={items.name}
